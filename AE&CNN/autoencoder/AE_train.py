...
def parse_args():
    ...
    parser.add_argument('--input_disease', nargs='?', default='.\data\disease_gene.csv',
                        help='Input disease_gene_relationship file')
    parser.add_argument('--input_miRNA', nargs='?', default='.\data\miRNA_gene.csv',
                        help = 'Input miRNA_gene_relationship file')
    parser.add_argument('--input_positive',nargs = '?',default='.\data\pos.txt',
                        help='positive samples')
    parser.add_argument('--input_negative', nargs='?', default='.\data\\neg.txt',
                        help='negative samples')
    parser.add_argument('--output', nargs='?', default='.\\result\disease_miRNA.csv',
                        help = 'Output low-dimensional disease_miRNA file')
    parser.add_argument('--label_file', nargs='?', default='.\\result\label.csv',
    ...
    parser.add_argument('--optimizer', nargs='?',default= tf.train.AdamOptimizer,
                        help='optimizer used in minimize the loss')
